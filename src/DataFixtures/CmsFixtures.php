...
namespace Softspring\CmsDataPlugin\DataFixtures;
...
class CmsFixtures extends Fixture implements FixtureGroupInterface
{
    ...
    public function __construct(ContainerInterface $container, DataImporter $dataImporter, ?LoggerInterface $cmsLogger, protected StructuredDataStorage $structuredDataStorage)
    {
