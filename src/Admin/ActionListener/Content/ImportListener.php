...
namespace Softspring\CmsDataPlugin\Admin\ActionListener\Content;
...
class ImportListener extends AbstractContentListener
{
    ...
    public function __construct(
        ...
        protected ZipArchiveManager $zipArchiveManager,
    ) {
    ...
    public function onApply(ApplyEvent $event): void
    {
        ...
        $this->dataImporter->import($this->zipArchiveManager->read($zipFile->getPath(), $zipFile->getBasename()), ['version_origin' => ContentVersionInterface::ORIGIN_IMPORT]);
